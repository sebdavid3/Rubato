      ...
      <main className="bg-bgDark min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-textSecondary font-montserrat mb-6">
            La edición del festival 2023 no está disponible.
          </p>
          <Link 
            href="/festival"
        ...
        <div className="container mx-auto px-8 md:px-16 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-textSecondary text-lg font-montserrat max-w-3xl mx-auto">
              Músicos de talla internacional que nos acompañaron desde Chile, España y Suiza.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {artistasInternacionales.map((artista) => (
              <div 
                key={artista.id} 
